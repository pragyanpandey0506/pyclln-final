...
## Structure
- Training scripts live in `scikit_digit/` (`dense_trainer.py`, `auto_prune_trainer.py`, `dense_trainer_avgappr.py`).
- Sweep launcher is `scikit_digit/auto_prune_sweep.py`.
